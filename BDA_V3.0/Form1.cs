...
namespace BDA_V3._0
{
    public partial class Form1 : Form
    {
        ...
        private void subButton(System.Windows.Forms.Button oClick)
        {
            switch (oClick.Name)
            {
                //瀏覽檔案
                ...
                case "btnRead":
                    {
                        if(clsGlobe.max_v_posiotn!=0 && clsGlobe.min_v_posiotn!=0 && clsGlobe.max_t_posiotn!=0 && clsGlobe.SOC_postion != 0)
                        {
